      ...
      <div class="card-body">
        <div class="row">
          <div class="col-lg-6">
            ...
            <input type="text" class="form-control"  placeholder="Disease" name="name" value="{{$disease->name}}">
            </div>
            ...
            <div class="form-group">
              ...
              <select name="type" id="" class="form-control">
                ...
                <option value="{{$type->id}}" @if($disease->disease_type_id == $type->id)selected="selected"@endif>{{$type->name}}</option>
                @endforeach
              </select>
            </div>
